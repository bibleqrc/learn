...
from os import path
LTP_DATADIR = path.normpath(path.join(path.dirname(path.abspath(__file__)), '../project/ltp_data/'))
# print LTP_DATADIR
STOPWORDS_FILE = path.normpath(path.join(path.dirname(path.abspath(__file__)), '../project/stopwords.txt'))
